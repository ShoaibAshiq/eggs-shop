...
?>
    <div id="payment">
        ...
        <div class="payment">
            ...
            <div class="payment__subtitle">Credit Card Charge</div>
            ...
            <?php echo apply_filters('woocommerce_order_button_html', '<input type="submit" class="button" name="woocommerce_checkout_place_order" id="place_order" value="Place Order Now" data-value="Place Order Now" />'); ?>
