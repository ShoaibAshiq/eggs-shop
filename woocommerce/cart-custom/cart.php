...
<form class="woocommerce-cart-form"
  ...
  <div class="shopping__items">
	  ...
	  ?>
    <div
      class="item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
      <div class="center">
		  <?php
		  $thumbnail = wp_get_attachment_image_src( $_product->get_image_id(), 'full' );
		  ?>
        <div class="item__img"
             style="background-image: url(<?php echo $thumbnail[0]; ?>);"></div>
        <div class="item__info">
          ...
          <div class="item__price"> <?php
			  ...
			  ?></div>
          <div class="item__number">Item
            # <?php echo $_product->get_sku(); ?></div>
        ...
        <div class="item__details">
          ...
          <div class="operations"><a href="<?php echo $product_permalink ?>">
              <svg xmlns="http://www.w3.org/2000/svg">
                <use
                  xlink:href="<?php echo TEMPLATEURI; ?>/svg/checkout_icons.svg#edit"></use>
              </svg>
            </a>
