...
<form class="woocommerce-shipping-calculator"
  ...
  <p><a href="#"
        class="shipping-calculator-button"><?php _e( 'Calculate shipping', 'woocommerce' ); ?></a>
  </p>
  ...
  <section class="shipping-calculator-form" style="display:none;">
    ...
    <p class="form-row form-row-wide" id="calc_shipping_country_field">
      <select name="calc_shipping_country" id="calc_shipping_country"
        ...
        <option
          value=""><?php _e( 'Select a country&hellip;', 'woocommerce' ); ?></option>
		  <?php
		...
		if ( is_array( $states ) && empty( $states ) ) {
          ...
          <select name="calc_shipping_state" class="state_select"
                  ...
                  placeholder="<?php esc_attr_e( 'State / County', 'woocommerce' ); ?>">
							<option
                value=""><?php esc_html_e( 'Select a state&hellip;', 'woocommerce' ); ?></option>
			  <?php
