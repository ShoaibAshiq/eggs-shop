...
$('#toggle').on('click', function() {
	...
	<div id="primary" class="content-area">
        ...
        <div class='mobile_banner <?php echo $txtalign; ?>'><img style='background-image:url(<?php echo get_the_post_thumbnail_url();?>)'  src="<?php //echo get_the_post_thumbnail_url();?>"></div>
			<div class='center left' id='topicsactive' style='background-image:url(<?php echo get_the_post_thumbnail_url();?>);background-size:cover;'>
    			<div class="topic_wrapper_left w" >
