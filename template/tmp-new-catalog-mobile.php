<?php
/*
*	Template name: New Catalog Mobile
*/
get_header(); ?>
...
if(curswi > 767) {
	window.location.href = "http://eggstime.com/digital-catalogue/";
}
});
...
if(curswi > 767) {
  ...
  <div class="main newcatalogue mobilecatalog">
...
<div class="container">
 ...
 echo "<div class='mobile_main_slider mobile-slider'>" . do_shortcode( $mobile_slider ). "</div>";
 ?>
	<div class="row">
