...
<div class="container">
 ...
 echo "<div class='desktop_main_slider'>" . do_shortcode( $desktop_slider ). "</div><div class='mobile_main_slider'>" . do_shortcode( $mobile_slider )."</div>";
 ?>
	<div class="row">
